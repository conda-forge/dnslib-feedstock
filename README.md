...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dnslib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7822&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dnslib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dnslib` can be installed with:

```
conda install dnslib
```

It is possible to list all of the versions of `dnslib` available on your platform with:
